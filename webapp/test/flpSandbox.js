		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List App",
									"targetURL": "#logalilistapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalilistapp-display": {
								"semanticObject": "logalilistapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.listapp",
									"url": sap.ui.require.toUrl("logali/listapp")
								}
							}
						}
					}
